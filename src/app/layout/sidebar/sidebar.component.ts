    ...
    items: [
      { icon: ICONS.products, label: 'Products', route: '/products', roles: ['SUPER_ADMIN', 'ADMIN', 'INVENTORY'] },
      {
        ...
        children: [
          ...
          { icon: ICONS.vendors,     label: 'Vendors',      route: '/vendors',      roles: ['SUPER_ADMIN', 'ADMIN', 'INVENTORY'] },
          { icon: ICONS.lookupLists, label: 'Fields', route: '/custom-fields', roles: ['SUPER_ADMIN', 'ADMIN'] },
